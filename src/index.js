...
var ws_url = "ws://192.168.0.11:8090";
var call_id = 0;
var sock = null;
...
const market_deals = {
  type: "object",
  properties: {
      market: {type: "string", title: "Market", default: "ETHUSD"},
      limit: {type: "integer", title: "Limit", default: 50},
      last_id: {type: "integer", title: "Last_id", default: 1},
  }
};
        ...
        <Column width="1/2">
            ...
            <TabPanel tabId="market">
              <Accordion>
                ...
                <FormBox title="Market Transactions" method="market.deals" schema={market_deals}/>
              </Accordion>
            </TabPanel>
